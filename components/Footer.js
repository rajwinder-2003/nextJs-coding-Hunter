...
const Footer = () => {
  return (
    <div className='container lg:mx-8 bg-white rounded-lg p-6 shadow-xl mb-8 hover:shadow-violet-600 mt-60'>
        <footer className="px-4 divide-y dark:bg-gray-800 dark:text-gray-100">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3 justify-center items-center">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-violet-400">
                            <img src="favicon2.png" className='flex-shrink-0 w-10 h-10'/>
                        </div>
                        <span className="self-center text-2xl font-semibold">Hunting Coder</span>
                    </a>
                </div>
